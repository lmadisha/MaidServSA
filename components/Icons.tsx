...
export const IconMapPin: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path d="M20 10c0 6-4 10-6 10s-6-4-6-10a6 6 0 0 1 12 0Z" />
...
export const IconStar: React.FC<{ className?: string; filled?: boolean }> = ({
  className,
  filled,
}) => (
  <svg
...
export const IconBell: React.FC<{ className?: string; filled?: boolean }> = ({
  className,
  filled,
}) => (
  <svg
...
export const IconEye: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
